...
class NfcoreSchema {
    ...
    //
    public static String getSchemaPath(workflow, schema_filename=params.schema_file_path) {
    ...
    public static void validateParameters(workflow, params, log, schema_filename=params.schema_file_path) {
        def has_error = false
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
    ...
    //
    public static String paramsHelp(workflow, params, command, schema_filename=params.schema_file_path) {
        Map colors = NfcoreTemplate.logColours(params.monochrome_logs)
    ...
    //
    public static LinkedHashMap paramsSummaryMap(workflow, params, schema_filename=params.schema_file_path) {
